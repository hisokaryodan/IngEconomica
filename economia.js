...
function getDisminucionTiempo(nuevoSaldo, cuota, i) {
...
function getMesePorPagar(n, mes, cuota = true) {
...
// console.log(calcularCuota(vP, n, i));
// console.log(getTotalAbono(abono, i, newVp));
// console.log(nuevoSaldo(newVp, totalAbono));
